...
public class Home1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        messing = new javax.swing.JLabel();
        ...
        pnMenuLayout.setHorizontalGroup(
            ...
            .addGroup(pnMenuLayout.createSequentialGroup()
                .addGroup(pnMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnMenuLayout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addComponent(lbTrangchu, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnMenuLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lbsignup, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        signup.setPreferredSize(new java.awt.Dimension(913, 527));

        lbdangki.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        lbdangki.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbdangki.setText("Đăng kí");
        ...
        tfChucVu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên" }));
        ...
        signupLayout.setHorizontalGroup(
            ...
            .addGroup(signupLayout.createSequentialGroup()
                .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(signupLayout.createSequentialGroup()
                        .addGap(349, 349, 349)
                        .addComponent(lbdangki, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(signupLayout.createSequentialGroup()
                        .addGap(91, 91, 91)
                        ...
                        .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(tfUserName, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                                .addComponent(tfPassWord)
                                .addComponent(tfPassWord1))))
                    .addGroup(signupLayout.createSequentialGroup()
                        .addGap(362, 362, 362)
                        .addComponent(btndangki, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        signupLayout.setVerticalGroup(
            ...
            .addGroup(signupLayout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(lbdangki, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
                ...
                .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tfPassWord1, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tfChucVu, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 76, Short.MAX_VALUE)
                .addComponent(btndangki, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(75, 75, 75))
        );

        pnContainer.add(signup, "card5");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("Quản Lý");

        messing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icon/chat.png"))); // NOI18N
        messing.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                messingMouseClicked(evt);
            }
        });
        ...
        pnMainLayout.setVerticalGroup(
            pnMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 610, Short.MAX_VALUE)
            .addGroup(pnMainLayout.createSequentialGroup()
                .addGap(31, 31, 31)
                .addGroup(pnMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbOpen)
    ...
    private void messingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_messingMouseClicked
     Chat_server cs=new Chat_server();
     cs.setVisible(true);
    }//GEN-LAST:event_messingMouseClicked
    ...
    private void btndangkiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndangkiActionPerformed
        ...
        String Role = (String) tfChucVu.getSelectedItem();
        ...
        try {
            ...
            if (Username.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Thiếu nhập lại mật khẩu!", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (!Password.equals(ConfirmPassword)) {
                JOptionPane.showMessageDialog(new JFrame(), "Mật khẩu phải trùng khớp với mật khẩu đã nhập!", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (Role == null || Role.isEmpty()) {
                JOptionPane.showMessageDialog(new JFrame(), "Thiếu chọn chức vụ!", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                String insertSql = "INSERT INTO account2(username, password, role) VALUES(?,?,?)";
                PreparedStatement pstmt = conn.prepareStatement(insertSql);
            ...
            Logger.getLogger(Home1.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(new JFrame(), "Lỗi khi tạo tài khoản!", "Error", JOptionPane.ERROR_MESSAGE);
        } 
...
//            selectedProducts.clear();
    ...
    private javax.swing.JLabel messing;
